...
\chapter{System Overview}
	...
	\section{Aircraft}
		\subsection{Aircraft Summary}
			The airframe used in this \gls{uas} is a 3DR Solo, which is a COTS \gls{quadcopter}.  We have then added an independent payload that does not interface with the aircraft control system.
	...
	\section{Payload}
		\subsection{Payload Summary}
			The payload for this \gls{uas} is a computerized radio recorder.  We have elected to use a software defined radio as our radio frontend, as this allows us to rapidly reconfigure the payload for any range of frequencies.  This is connected to an Intel Joule, which handles all of the data collection, including collecting position data from the autopilot system.  Recorded data is organized into runs, which are stored on an SD card.
...
\chapter{Checklists and Flight Procedures}
	...
	\section{Before Aircraft and Payload Power On Check}
		See Section 5.1 in the 3DR Solo User Manual
